...
def test(strategy, test_set, plot=True):
    ...
    confusion_mat = torch.zeros((args.n_classes+1,args.n_classes+1))
    confusion_mat_e = torch.zeros((args.n_classes+1,args.n_classes+1))
    confusion_mat_taw = torch.zeros((args.n_classes+1,args.n_classes+1))
