...
from utils.split import split_train_balanced

def main():
    #data_path = os.path.expanduser('/davinci-1/home/dmor/PycharmProjects/Refactoring_MIND/data_64x64')
    project_path = '/davinci-1/home/micherusso/PycharmProjects/Refactoring_MIND'
    ...
    if args.aug_type == "rotations":
        for i in range(len(old_y)):
           # r prevents in creating more rotations 
            for k in range(r + 1):
    ...
    splited_dataset=split_train_balanced(new_x,new_y, 2 )
    new_x , new_y= splited_dataset[0] 
